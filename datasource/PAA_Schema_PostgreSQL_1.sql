...
COMMENT ON COLUMN attached_document.detected_doc_type IS 'Kết quả phân loại tài liệu tự động (document classifier) — dùng để định tuyến đúng luồng OCR/trích xuất field cho từng loại giấy tờ (sổ đỏ/sổ hồng, tờ khai LPTB, biên bản bàn giao, thông báo thuế đất...).';
